  ...
  return (
    <WavyBackground backgroundFill="#080808" className="max-w-4xl flex flex-col items-center mx-auto">
      <div className="glass-hero rounded-3xl p-8 md:p-12 backdrop-blur-3xl text-center">
        <p className="text-2xl md:text-4xl mb-md lg:text-7xl text-white font-bold inter-var drop-shadow-lg">
          Ready to get started?
        </p>
        <p className="text-base md:text-xl mt-4 text-white/90 mb-lg font-normal inter-var drop-shadow-sm">
