    ...
    <Card className="bg-zinc-950 border-zinc-800">
      <CardHeader>
        <div className="space-y-1">
          ...
          <p className="text-sm text-zinc-400">Select additional services to enhance your package</p>
        </div>
      </CardHeader>
      <CardContent>
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="border-b border-zinc-800">
                <th className="text-left bg-zinc-900/50 p-4 text-zinc-400 font-medium">Feature</th>
                <th className="text-right bg-zinc-900/50 p-4 text-zinc-400 font-medium">Price</th>
              </tr>
            </thead>
            <tbody>
              {addOns.map((addon) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="p-4 text-right font-medium text-red-400">{addon.price}</td>
                  </tr>
                );
              })}
            </tbody>
