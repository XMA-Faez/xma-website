...
const PaymentSummary = ({ selectedPackage, selectedAddOns = [], onPayment }) => {
  ...
  const packagePrice = parseInt(packages[selectedPackage].price.replace(/[^0-9]/g, ''));
        ...
        <div className="space-y-6">
          ...
          {selectedAddOns.length > 0 && (
            <div className="border-t border-zinc-800 pt-4 space-y-2">
              <h4 className="text-sm font-medium text-zinc-400">Selected Add-ons</h4>
          ...
          <div className="border-t border-zinc-700 pt-6">
            <div className="flex justify-between items-center">
              ...
              >
                <span className="font-semibold">Pay {totalPrice.toLocaleString()} AED</span>
