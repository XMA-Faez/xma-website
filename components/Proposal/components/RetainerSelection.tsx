...
const RetainerSelection = ({ selectedRetainer, onRetainerSelect, isExpanded, onToggleExpand }) => {
  ...
  const retainerFeatures = [
    ...
    { name: 'Single Platform Ad Management', base: true, standard: true, premium: true },
    { name: 'Multi Platform Ad Management', base: false, standard: true, premium: true },
    { name: 'WhatsApp Marketing Management', base: false, standard: true, premium: true },
    { name: 'Monthly Graphics', base: '1', standard: '4', premium: '8' },
    { name: 'Monthly Videos', base: '0', standard: '0', premium: '4 in 1 Shoots' },
    ...
    <Card className="bg-zinc-950 border-zinc-800">
      <CardHeader>
        <div className="flex justify-between items-center">
          <CardTitle className="text-white">Monthly Retainer Selection</CardTitle>
