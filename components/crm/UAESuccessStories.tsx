      ...
      <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="text-2xl font-bold text-white">{currentStory.businessName}</h3>
                    ...
                    <p className="text-zinc-400">{currentStory.location}</p>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <blockquote className="pl-6 text-lg text-zinc-300 italic leading-relaxed">
                  ...
                  <div className="flex items-center gap-3 mt-6 pl-6">
                    ...
                    <div>
                      <p className="font-semibold text-white">{currentStory.owner.name}</p>
                      <p className="text-sm text-zinc-400">{currentStory.owner.title}</p>
                    </div>
                    {currentStory.testimonial.videoTestimonial && (
                      <button
                        onClick={() => setPlayingVideo(currentStory.id)}
                        className="ml-auto flex items-center gap-2 px-3 py-2 rounded-lg glass-primary hover:glass-secondary transition-all duration-300 text-sm"
                      >
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-green-400/5 border border-emerald-500/20">
                  ...
                  <p className="text-white font-medium">{currentStory.keyFeature}</p>
                </div>
              </div>
            ...
            <button
              ...
              className={`transition-all duration-300 ${
                activeStory === index
                  ...
                  : 'w-3 h-3 bg-zinc-700 hover:bg-zinc-600 rounded-full'
              }`}
            />
          ))}
        </div>
        ...
        >
          <div className="text-center p-6 rounded-2xl glass-primary">
            ...
            <div className="text-zinc-400">UAE Businesses</div>
          </div>
          
          <div className="text-center p-6 rounded-2xl glass-primary">
            <div className="text-3xl font-bold text-emerald-400 mb-2">150%</div>
            <div className="text-zinc-400">Avg. Lead Increase</div>
          </div>
          
          <div className="text-center p-6 rounded-2xl glass-primary">
            <div className="text-3xl font-bold text-emerald-400 mb-2">24/7</div>
            <div className="text-zinc-400">AI Response Time</div>
          </div>
