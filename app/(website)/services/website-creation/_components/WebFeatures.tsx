...
import { Zap, Palette, TrendingUp, FileEdit } from "lucide-react";
...
const features: Feature[] = [
  {
    ...
    description:
      "Sub-2-second load times powered by Next.js. Your site loads before visitors can blink \u2014 on any device, any connection, anywhere in the world.",
    icon: <Zap />,
    color: {
      bg: "from-blue-500/10 to-sky-400/5",
      text: "text-blue-400",
    ...
    screenshot: {
      placeholder:
        "PageSpeed Performance Dashboard - Shows 98/100 score with Core Web Vitals metrics",
      aspectRatio: "16/9",
    },
    demoComponent: PageSpeedDemo,
  },
  {
    id: "design",
    title: "Premium Design",
    description:
      "Custom design that reflects the premium quality of your brand. No templates. No compromises. Every pixel crafted with intention.",
    icon: <Palette />,
    color: {
    ...
    screenshot: {
      placeholder:
        "Design Showcase - Color palette, typography system, and responsive layout demonstrations",
      aspectRatio: "16/9",
    },
    demoComponent: DesignShowcase,
  },
  {
    id: "conversion",
    title: "Conversion Optimization",
    description:
      "Strategic UX, clear booking flows, and trust signals that turn browsers into customers. Your traffic finally pays off.",
    icon: <TrendingUp />,
    color: {
    ...
    screenshot: {
      placeholder:
        "Responsive Preview - Desktop, tablet, and mobile frames showing adaptive design",
      aspectRatio: "16/9",
    },
    demoComponent: ResponsivePreview,
  },
  {
    id: "cms",
    title: "Content Management",
    description:
      "Sanity CMS gives you complete control over your content. Update text, images, and pages without touching code \u2014 or waiting for a developer.",
    icon: <FileEdit />,
    color: {
    ...
    screenshot: {
      placeholder:
        "CMS Content Editor - Sanity Studio interface with real-time editing and media management",
      aspectRatio: "16/9",
    },
    demoComponent: CMSContentDemo,
  },
];
  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="relative z-10 text-center px-4">
        ...
        >
          <Badge variant="primary" size="lg" className="mb-6 md:mb-8">
