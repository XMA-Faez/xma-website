...
function StepCard({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="group flex flex-row md:flex-col items-start md:items-center gap-4 md:gap-0 md:text-center flex-1 px-3 py-4 md:px-4 md:py-6 rounded-xl hover:bg-white/[0.03] transition-colors duration-300"
    >
      <div
